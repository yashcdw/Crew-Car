...
class WalletFunctionalityTest(unittest.TestCase):
    ...
    def test_06_get_wallet_transactions_empty(self):
        ...
        response = self.api_call("/api/wallet/transactions", token=self.token)
        self.assertEqual(response.status_code, 200)
        data = response.json()
...
if __name__ == "__main__":
    ...
    test_suite.addTest(WalletFunctionalityTest('test_05_book_trip_with_insufficient_wallet_balance'))
    test_suite.addTest(WalletFunctionalityTest('test_06_get_wallet_transactions_empty'))
    test_suite.addTest(WalletFunctionalityTest('test_07_unauthorized_wallet_access'))
    test_suite.addTest(WalletFunctionalityTest('test_08_wallet_topup_endpoint_structure'))
    test_suite.addTest(WalletFunctionalityTest('test_09_invalid_package_topup'))
    test_suite.addTest(WalletFunctionalityTest('test_10_cleanup_created_trip'))
